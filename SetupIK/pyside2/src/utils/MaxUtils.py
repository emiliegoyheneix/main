...
class MaxUtilsIKChain:
    def __init__(self, prefix=""):
        self.objs_hi_names = [  f"{prefix}root_PT",
                                ...
                                f"{prefix}ctrl_PT"]
        self.fix_pt_name = f"{prefix}fix_PT"
    ...
    def build_hierarchy(self, hdl, hdl_jnts):
        ...
        self.lookat(objs_hi)
        self.fix_hierarchy(hdl_jnts, objs_hi)
        return objs_hi
    ...
    def fix_hierarchy(self, hdl_jnts, objs_hi):
        fix_pt = rt.Point(pos=hdl_jnts[0].pos, name=rt.uniqueName(self.fix_pt_name))
        fix_pt.parent = objs_hi[1]
        hdl_jnts[0].parent = fix_pt
